...
const MoviesGrid = ({ movies, favourites}: MoviesGridType) => {
  return (
    <section className="mt-8 pb-16" aria-labelledby="gallery-heading">
      ...
      <ul
        role="list"
        className="grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-2 sm:gap-x-6 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 xl:gap-x-8 justify-items-center lg:justify-items-baseline "
      >
        {movies.map((movie) => {
